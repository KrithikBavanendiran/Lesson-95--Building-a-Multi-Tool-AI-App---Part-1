...
Solve with clear step-by-step reasoning, corret notation, and a final answer."""

CHAT_CSS="""
<style>
.wrap{max-heigth: 520px; overflow-y: auto; padding: 6px;}
.card{border;1px solid #e6e6e6;background:#fff;border-radius:10px;padding:14px 16px;margin:10px 0:box-shadow:0 1px 2px rgba(0,0,0,.04);}
.q{font-weight:700;color:#0a63bd;margin-bottom:8px;}
.meta{disolay:inline-block;background:#FF9800;color:#fff;padding:2px 8px;border-radius;12px;font-size:12px;margin-left:8px}
